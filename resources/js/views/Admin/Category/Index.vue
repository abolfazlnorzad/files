    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-primary d-flex justify-content-between">
                ...
                <router-link :to="{ name: 'admin-categories', params: { url: 'create' } }" class="btn btn-info"><i
                    class="fa fa-plus-circle"></i> دسته بندی جدید
                </router-link>
            </div>
            <div class="card-body">
                        ...
                        <tr v-for="(category, index) in categories.data">
                            ...
                            <td>
                                <router-link class="btn btn-info"
                                             :to="{ name: 'admin-categories-edit', params: { url: 'edit', slug: category.slug } }">
                                    ویرایش
                                </router-link>

                                <button class="btn btn-danger" @click="deleteCategory(category.slug, index)">حذف
                                </button>
                            </td>
                        </tr>
                        </tbody>
            ...
            getCategories(page) {
                this.$store.dispatch('category/categories', page)
                    .then(({data}) => {
                        ...
                        window.history.replaceState('category', 'category', `/admin/category?page=${page}`)
                    })
            },
