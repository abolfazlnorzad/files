    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-primary d-flex justify-content-between">
                ...
                <router-link :to="{ name: 'admin-discounts', params: { url: 'create' } }" class="btn btn-info"><i
                    class="fa fa-plus-circle"></i> کد تخفیف جدید
                </router-link>
            </div>
            <div class="card-body">
                        ...
                        <tr v-for="(discount, index) in discounts.data" :key="discount.id">
                            ...
                            <td>
                                <router-link class="btn btn-info"
                                             :to="{  name: 'admin-discount-edit', params: { url: 'edit', code: discount.code } }">
                                    ویرایش
                                </router-link>
                                <button class="btn btn-danger" @click="removeDiscount(discount.code, index)">حذف
                                </button>
                            </td>
                        </tr>
                        </tbody>
