...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    deleteUser: function deleteUser(id, index) {
      ...
      _plugin_axios__WEBPACK_IMPORTED_MODULE_1__["default"]["delete"]("/api/admin/users/".concat(id)).then(function () {
    ...
    getUsers: function getUsers() {
      ...
      _plugin_axios__WEBPACK_IMPORTED_MODULE_1__["default"].get("/api/admin/users?page=".concat(page)).then(function (_ref) {
        var data = _ref.data;
        _this2.users = data;
