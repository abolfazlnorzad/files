(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/admin-user-routes"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    _plugin_axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(this.url).then(function (_ref) {
      var data = _ref.data;
      ...
      _c("div", { staticClass: "card-body" }, [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("base-check", {
              attrs: { label: "ادمین", name: "isAdmin" },
              model: {
