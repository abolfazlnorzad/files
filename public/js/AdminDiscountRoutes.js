(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/AdminDiscountRoutes"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    storeDiscount: function storeDiscount() {
      ...
      this.form.post('/api/admin/discount', this.form).then(function () {
        swal.success('کد تخفیف به درستی ایجاد شد');
  ...
  methods: {
    updateDiscount: function updateDiscount() {
      ...
      this.form.patch('/api/admin/discount/' + this.code).then(function () {
        swal.success('کد تخفیف به درستی ویرایش شد');
    ...
    _c("div", { staticClass: "card" }, [
      ...
      _c("div", { staticClass: "card-body" }, [
        _c(
          ...
          [
            _c("base-input", {
              attrs: { label: "نام کد تخفیف", name: "code" },
              model: {
                value: _vm.form.code,
                callback: function($$v) {
