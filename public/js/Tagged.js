(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/Tagged"],{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                queries.page = page;
                _context.next = 5;
                return _this.$store.dispatch('file/getTaggedFiles', {
                  queries: queries,
                  params: _this.$route.params
                });

              case 5:
                _this.category = _this.$store.state.file.files.data[0].categories[0].name;
